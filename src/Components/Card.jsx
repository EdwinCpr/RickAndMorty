  ...
  return (
    <div className="card background-secundary">
      <div className="card-img">
        <img src="https://rickandmortyapi.com/api/character/avatar/14.jpeg" alt=""/>
      ...
      <div className="card-info">
        <h2 className="name font-weight-none">{Name}</h2>
        ...
        <div className="card-episode margin-top-primary">
          <p className="bold font-size-small color-gray">APARICION EN EPISODIOS</p>
